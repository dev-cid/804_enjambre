          ...
          *{
          ...
          <div  class="container ${!this.isOpen ? 'closed': ''}" style=" height:${this.isOpen ?'400px': this._height}">
            <header @click="${this.toggleOpen}" class="header-item flex">
              ...
              <div class="span-number">${this.index+1}</div>
...
customElements.define('syllabus-item', SyllabusItem)
               ...
               this.htm.map((htm, index )=>{
                 return html`
                  <syllabus-item
                    ...
                    .callback="${this.openInfo.bind(this)}"
                  >
                    ${unsafeHTML(htm[2])}
                  </syllabus-item>
                 `
...
customElements.define("syllabus-element", Syllabus)